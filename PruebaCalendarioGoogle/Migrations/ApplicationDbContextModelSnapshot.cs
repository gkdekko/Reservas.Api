...
using PruebaCalendarioGoogle.Models;

namespace PruebaCalendarioGoogle.Migrations
{
    ...
    partial class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override void BuildModel(ModelBuilder builder)
        {
            ...
            builder.Entity("PruebaCalendarioGoogle.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("PruebaCalendarioGoogle.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
